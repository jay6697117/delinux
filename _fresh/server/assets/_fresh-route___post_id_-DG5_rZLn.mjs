...
function sanitizeHtml(html2) {
  ...
  html2 = html2.replace(/href\s*=\s*['"]javascript:[^'"]*['"]/gi, 'href="#"');
  return html2;
}
...
const $$_tpl_5 = ['<div class="reply-item" ', '><div class="reply-header">', '<span class="reply-time">', '</span><span class="reply-floor">#', "</span></div>", "</div>"];
const $$_tpl_6 = ['<div class="card" ', '><div class="card-body">', '<form method="POST"><div class="form-group"><textarea class="form-input" name="content" placeholder="写下你的回复（支持 Markdown）" ', ' required></textarea></div><button type="submit" class="btn btn-primary">回复</button></form></div></div>'];
const $$_tpl_7 = ['<div class="alert alert-error">', "</div>"];
const $$_tpl_8 = ['<div class="card" ', "><p ", ">", " 后参与讨论</p></div>"];
...
const _id_ = define.page(function PostDetail({
  data,
  state
}) {
  const {
  ...
  }), s(formatDate(post.createdAt)), s(post.likeCount), s(post.replyCount), u("div", {
    class: "post-detail-content",
    dangerouslySetInnerHTML: {
      __html: htmlContent
    }
  }), s(state.user && a($$_tpl_2, l("style", {
    display: "inline"
  }), l("value", post.id), l("class", `action-btn ${liked ? "active" : ""}`), s(liked ? "👍 已赞" : "👍 点赞"), s(post.likeCount), l("style", {
    display: "inline"
  }), l("value", post.id), l("class", `action-btn ${favorited ? "active" : ""}`), s(favorited ? "⭐ 已收藏" : "☆ 收藏"), s(state.user.role === "admin" && a($$_tpl_3, l("style", {
    display: "inline",
    marginLeft: "auto"
  }), l("value", post.id), l("style", {
    color: "var(--danger)"
  }))))), l("style", {
    marginTop: "var(--space-md)"
  }), s(post.replyCount), s(replies.length === 0 ? a($$_tpl_4, l("style", {
    padding: "var(--space-lg)"
  })) : replies.map((reply, i) => a($$_tpl_5, l("key", reply.id), u("a", {
  ...
  })))), s(state.user ? a($$_tpl_6, l("style", {
    marginTop: "var(--space-md)"
  }), s(replyError && a($$_tpl_7, s(replyError))), l("style", {
    minHeight: "100px"
  })) : a($$_tpl_8, l("style", {
    marginTop: "var(--space-md)",
    textAlign: "center",
...
const _freshRoute___post_id_ = _id_;
export {
  config,
  css,
  _freshRoute___post_id_ as default,
  handler,
  handlers
};
