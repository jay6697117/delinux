...
DeLinux 是一个使用 Deno + Fresh 构建的轻量级中文论坛社区，专注于 **AI 技术交流**和**日常生活分享**。无需外部数据库，开箱即用。
...
- [Deno](https://deno.com) >= 2.x（[安装指南](https://docs.deno.com/runtime/getting_started/installation/)）
...
> **💡 提示**：本地开发模式会自动使用 `./local.sqlite` 作为数据库文件，数据与线上环境完全隔离。
...
非常欢迎你参与 DeLinux 的开发！无论是修复 Bug、改进功能、完善文档，都是宝贵的贡献。
...
提交信息使用中文，格式遵循 [Conventional Commits](https://www.conventionalcommits.org/)：
...
如果你发现了 Bug，请在 [Issues](https://github.com/jay6697117/delinux/issues) 中创建 issue，并包含：
...
欢迎在 [Issues](https://github.com/jay6697117/delinux/issues) 中提出功能建议，标注 `enhancement` 标签。
